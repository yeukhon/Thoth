...
class EditorClass(object):
    ...
    def __init__(self, master):
        ...
        self.frame = Frame(master, width=400, bd=2, relief=SUNKEN)
        ...
        self.text = Text(self.frame,
                ...
                padx = 4,
                undo=True,
                bg='#333', fg='#FFF', insertbackground='#FFF', selectbackground='#3399FF', selectforeground='#FFF'
        )
        ...
        self.text.bind("<KeyPress-space>", self.handle_spacebar)
